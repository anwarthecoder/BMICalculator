...
<body>
    <div class="center">
        <div class="result-container">
            ...
            if (isset($_GET['result'])) {
                ...
                echo "Your BMI is: " . htmlspecialchars($bmi) . "<br>You belong to <span class='beat-animation'><b>OVERWEIGHT</span></b> category";
            } else {
    ...
    <section class="advice">
        <div class="content">
            <h2><u>Advices for Overweight Individuals</u></h2>
            <p>
